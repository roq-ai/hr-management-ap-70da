...
import { useInterviewsFindFirst, useRoqClient } from 'lib/roq';
...
function InterviewsViewPage() {
  ...
  const { data, error, isLoading } = useInterviewsFindFirst(queryParams, {}, { disabled: !id });
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('interviews', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
              ...
              >
                ...
                <FormListItem label="Interviewer Id" text={data?.interviewer_id} />
